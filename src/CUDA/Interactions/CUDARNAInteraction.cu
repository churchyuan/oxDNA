...
void CUDARNAInteraction::_near_hb_op_precalc(c_number4 *poss, GPU_quat *orientations, int *op_pairs1, int *op_pairs2, bool *nearly_bonded_array, int n_threads, bool *region_is_nearhb, CUDA_kernel_cfg ffs_hb_precalc_kernel_cfg, CUDABox*d_box) {
	rna_near_hb_op_precalc<<<ffs_hb_precalc_kernel_cfg.blocks, ffs_hb_precalc_kernel_cfg.threads_per_block>>>(poss, orientations, op_pairs1, op_pairs2, nearly_bonded_array, n_threads, region_is_nearhb, d_box);
	CUT_CHECK_ERROR("nearhb_op_precalc error");
}

void CUDARNAInteraction::_dist_op_precalc(c_number4 *poss, GPU_quat *orientations, int *op_pairs1, int *op_pairs2, c_number *op_dists, int n_threads, CUDA_kernel_cfg ffs_dist_precalc_kernel_cfg, CUDABox*d_box) {
	rna_dist_op_precalc<<<ffs_dist_precalc_kernel_cfg.blocks, ffs_dist_precalc_kernel_cfg.threads_per_block>>>(poss, orientations, op_pairs1, op_pairs2, op_dists, n_threads, d_box);
