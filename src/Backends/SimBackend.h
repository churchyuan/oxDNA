...
[external_forces_file = <path> (specifies the file containing all the external forces' configurations. Currently there are several supported force types: string, twist, twist_constraint, trap, repulsion_plane, attraction_plane, repulsion_plane_moving and mutual_trap (see EXAMPLES/TRAPS for some examples))]
